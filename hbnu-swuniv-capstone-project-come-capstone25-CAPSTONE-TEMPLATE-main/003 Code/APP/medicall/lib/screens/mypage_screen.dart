...
class _MyPageScreenState extends State<MyPageScreen> {
  ...
  void _initializeControllers() {
    ...
    _surgeryHistoryController = TextEditingController(
      text: widget.surgeryHistory,
    );
    _otherMedicalInfoController = TextEditingController(
      text: widget.otherMedicalInfo,
    );
    ...
    _selectedBloodType =
        validBloodTypes.contains(widget.bloodType) ? widget.bloodType : '미등록';

    final validRelations = ['부모', '배우자', '자녀', '형제', '친구', '기타'];
    _selectedEmergencyContactRelation =
        validRelations.contains(widget.emergencyContactRelation)
